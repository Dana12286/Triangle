...
// // Initialize OpenAI API client with hard-coded API key
...
// // Function to fetch and parse events from the given URL
...
//   const monthIndex = moment(month).month(); // January = 0, February = 1, etc.
